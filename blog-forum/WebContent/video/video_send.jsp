...
<div class="container">
	<div class="col-sm-offset-3 col-sm-6">
		<form name="uploadVideoForm" action="../UploadVideoAdmin" method="post" enctype="multipart/form-data" onsubmit="return CheckForm();">
	    	<div class="form-group">
				<label for="fileName" class="control-label">视频名称</label>
			...
			<div class="form-group">
				<label for="username" class="control-label">视频上传者</label>
				<div class="input-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">上传视频须知</h4>
			</div>
			<div class="modal-body">
				1、请上传积极健康的视频。<br>
				2、视频上传格式要求是：mp4、mkv、avi
			</div>
...
<script type="text/javascript">	
	function CheckForm(){
		...
		if(document.uploadVideoForm.fileName.value==""){
			alert("请选择上传的视频！");
			return false;
		}
