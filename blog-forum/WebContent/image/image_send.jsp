...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a href="image_main.jsp" class="navbar-brand">图片天堂</a>
			<a class="navbar-brand">/</a>
			<a class="navbar-brand">上传图片</a>
		</div>
...
<div class="container">
	<div class="col-sm-offset-3 col-sm-6">
		<form name="uploadImageForm" action="../UploadImageAdmin" method="post" enctype="multipart/form-data" onsubmit="return CheckForm();">		
			<div class="form-group">
				<label for="fileName" class="control-label">图片名称</label>
			...
			<div class="form-group">
				<label for="username" class="control-label">图片上传者</label>
				<div class="input-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">上传图片须知</h4>
			</div>
			<div class="modal-body">
				1、请上传积极健康的图片。<br>
				2、图片上传格式要求是：jpg、png、jpeg
			</div>
...
<script type="text/javascript">	
	function CheckForm(){
		...
		if(document.uploadImageForm.fileName.value==""){
			alert("请选择上传的图片！");
			return false;
		}
